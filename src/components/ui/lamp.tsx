  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          initial={{ opacity: 0.5, width: isMobile ? "4rem" : "15rem" }}
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[15rem] sm:w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[15rem] sm:w-[30rem] bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        ></motion.div>
        <motion.div
          initial={{ width: isMobile ? "4rem" : "15rem" }}
          whileInView={{ opacity: 1, width: isMobile ? "15rem" : "30rem" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
          ...
          className="absolute inset-auto z-50 h-0.5 w-[15rem] sm:w-[30rem] -translate-y-[7rem] bg-cyan-400 "
        ></motion.div>
