...
import { ArrowRight, Images, Layers2, PanelRightClose } from "lucide-react";
...
export default function Layers() {
  ...
  return (
    <>
      ...
      <Card
        className={cn(
          "fixed lg:relative right-0 top-0 h-[calc(100vh-2rem)] lg:h-auto basis-[360px] my-4 mr-4 shrink-0 overflow-y-auto overflow-x-hidden flex flex-col shadow-2xl rounded-2xl transition-transform duration-300 ease-in-out z-40",
          {
